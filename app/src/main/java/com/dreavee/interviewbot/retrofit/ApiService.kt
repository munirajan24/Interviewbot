...
//        @Header("X-RapidAPI-Host") XRapidApiHost: String,
    ...
    ): Response<com.dreavee.interviewbot.model.TtsRapidAPIResult>
    ...
    @GET("tts")
    suspend fun getTtsWithId(@QueryMap params: Map<String,String>): Response<com.dreavee.interviewbot.model.TtsWithIdApiResult>
}