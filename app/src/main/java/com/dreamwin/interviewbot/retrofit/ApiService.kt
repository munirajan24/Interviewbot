...
//        @Header("X-RapidAPI-Host") XRapidApiHost: String,
    ...
    ): Response<com.dreamwin.interviewbot.model.TtsRapidAPIResult>
    ...
    @GET("tts")
    suspend fun getTtsWithId(@QueryMap params: Map<String,String>): Response<com.dreamwin.interviewbot.model.TtsWithIdApiResult>
}