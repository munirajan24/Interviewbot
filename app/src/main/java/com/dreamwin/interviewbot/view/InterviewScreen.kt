package com.dreamwin.interviewbot.view
...
import com.dreamwin.interviewbot.R
import com.dreamwin.interviewbot.utils.EncryptionUtils
import com.dreamwin.interviewbot.viewmodel.MyViewModel
...
class InterviewScreen : AppCompatActivity(), OnInitListener {
    ...
    private lateinit var show_questions: Button
...
//            askQuestion(currentQuestion)
        ...
        img_sync.setOnClickListener {
            Intent(this, SyncPage::class.java).apply {
                startActivity(this)
            }
        }
        playIB.setOnClickListener {
            currentQuestion = questionList[position]
            askQuestion(true, currentQuestion)
        }
        btnJava.setOnClickListener {
            setQuestionsListJava()
            askQuestion(true, "Java topic selected")
            askQuestion(false, "Totally ${questionList.size}Questions in the queue")
        }
        btnKotlin.setOnClickListener {
            setQuestionsListKotlin()
            askQuestion(true, "Kotlin topic selected")
            askQuestion(false, "Totally ${questionList.size}Questions in the queue")
        }
        btnAndroid.setOnClickListener {
            setQuestionsListAndroid()
            askQuestion(true, "Android topic selected")
            askQuestion(false, "Totally ${questionList.size}Questions in the queue")
        }
...
//            callTtsApi(currentQuestion)
                ...
                askQuestion(true, "you have completed all questions... Well done")
            }
        }
...
//            pauseAudio()
        ...
        show_questions.setOnClickListener {
            showQuestionsInAlertDialog()
        }
...
//        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "") // Provide an empty string as the prompt
    ...
    private fun askQuestion(showText: Boolean, textToAsk: String) {
...
//    }
    ...
    private fun setQuestionsListAndroid() {
        ...
        questionList.add("What is Activity?")
        ...
        questionList.add("How can you handle background tasks in Android 11 and later versions?")
        questionList.add("✍️How can you handle background tasks in Android 10 and before versions?")
        questionList.add("Difference between serializable and parcelable? Which is the best approach in Android ?")
        ...
        questionList.add("Can you tell me about RxJava? How it works? And its functionalities?")
        questionList.add("How will you handle error in RxJava?")
        questionList.add("How custom error handler works ?")
        questionList.add("Explain the concept of dependency injection and its benefits in Android development?")
        questionList.add("What is meant by dagger? How it works?")
        questionList.add("What is meant by Hilt ? How it works ?")
        questionList.add("What is content provider?")
        questionList.add("* What is MVVM pattern ? Explain")
        ...
        questionList.add("MVVM sample project explanation?")
        ...
        questionList.add("What is the purpose of the ConstraintLayout in Android?")
        questionList.add("Features of ConstraintLayout?")
        ...
        questionList.add("What are Android Jetpack components.?")
        ...
        questionList.add("What is WorkManager?")
        questionList.add("Work manager vs coroutine / background processing in latest Android Components?")
        ...
        questionList.add("Important parts of Jetpack compose?")
        questionList.add("What are Composable Functions?")
        questionList.add("How State Management works in compose?")
        questionList.add("What is remember()?")
        questionList.add("What is MutableState?")
        questionList.add("Approach for Theming and Styles in compose?")
        questionList.add("What are Composable Modifiers?")
        questionList.add("What is Navigation in compose?")
        questionList.add("What are Side Effect APIs?")
    }
    ...
    private fun setQuestionsListJava() {
        ...
        questionList.add("What is constructor?")
        ...
        questionList.add("Tell me about java collections?")
        ...
        questionList.add("✍️Sorting methods in Java?")
        questionList.add("Sorting algorithms?")
        questionList.add("What is Stream in java?")
        questionList.add("What are the operations in stream in Java?")
        questionList.add("Difference between flatMap and map?")
        questionList.add("What are generics in Java?")
        questionList.add("Why do we use generics in Java?")
        questionList.add("What is a type parameter?")
        questionList.add("How do you define a generic class in Java?")
        questionList.add("What is a bounded type parameter?")
        questionList.add("What is the difference between upper bounded and lower bounded wildcards?")
        questionList.add("How can you restrict the types that can be used as type arguments in generics?")
        questionList.add("What is type erasure in Java generics?")
        questionList.add("How does the diamond operator (<>) improve code readability in Java generics?")
        questionList.add("What is the difference between <? extends T> and <? super T> wildcards?")
        questionList.add("How do you create a generic interface in Java?")
        questionList.add("Can you use primitives as type arguments in generics?")
        questionList.add("How does the Comparable interface relate to generics?")
        questionList.add("Tell me about major updates in Java 8 features?")
        questionList.add("What is Lambda Expression in java?")
        questionList.add("What is Method Reference in java?")
        questionList.add("What is Stream API?")
        questionList.add("Tell me about the Date and Time API?")
        questionList.add("What is Default Method?")
        questionList.add("What is Functional Interface?")
        questionList.add("What is Optional Class?")
        questionList.add("What is Parallel Array Sorting?")
        questionList.add("Features of Java 9?")
        questionList.add("Features of Java 10?")
        questionList.add("Features of Java 11?")
        questionList.add("Features of Java 12?")
        questionList.add("Features of Java 14?")
        questionList.add("Features of Java 15?")
        questionList.add("Features of Java 17?")
        questionList.add("How are variables passed to methods? pass by value or pass by reference?")
        questionList.add("What is the difference between final, finally, and finalize?")
        questionList.add("What is a String pool?")
    ...
    private fun setQuestionsListKotlin() {
        ...
        position = 0
        currentQuestion = ""
        questionList.add("What is Kotlin?")
        questionList.add("✍️What is Functional Programming in Java?")
        questionList.add("Difference between kotlin and java?")
        questionList.add("Difference between Kotlin and Java on Functional programming?")
        questionList.add("For loop changes in kotlin?")
        questionList.add("What is object keyword?")
        questionList.add("What is companion object in kotlin?")
        questionList.add("What is higher order function?")
        questionList.add("What is Safe call operator?")
        questionList.add("What is Elvis operator (?:) Means in Kotlin?")
        questionList.add("What is Not Null Assertion operator?")
        ...
        questionList.add("✍️Val vs const difference in Kotlin?")
        questionList.add("When to use the lateinit keyword?")
        ...
        questionList.add("What is the reference operator/ reflection in kotlin?")
        questionList.add("What is Visibility modifiers in kotlin?")
        questionList.add("Protected vs internal?")
        questionList.add("What are the different class declaration / inheritance  modifiers in kotlin?")
        questionList.add("What is inner in kotlin?")
        questionList.add("Tell me about constructors in kotlin?")
        questionList.add("What are coroutines?")
        questionList.add("What is lightweight?")
        questionList.add("What is scope in kotlin?")
        questionList.add("What are the scopes we have?")
        questionList.add("What is Scope functions?")
        questionList.add("Use of scope functions?")
        questionList.add("Suspend function?")
        questionList.add("✍️What is inline function?")
        questionList.add("✍️What is actual function?")
        questionList.add("✍️ What are Coroutine Builders?")
        questionList.add("What is launch?")
        questionList.add("What is async?")
        questionList.add("What is await?")
        questionList.add("What is runBlocking { }?")
        questionList.add("✍️What is withContext?")
        questionList.add("Launch vs Async ?")
        questionList.add("What are Dispatchers?")
        questionList.add("Types of dispatcher?")
        questionList.add("What is extension function?")
        questionList.add("List useful higher-order functions for collections in Kotlin?")
        questionList.add("Explain the any function for collections in Kotlin?")
        questionList.add("Explain the all function for collections in Kotlin?")
        questionList.add("Explain the none function for collections in Kotlin?")
        questionList.add("Explain the find function for collections in Kotlin?")
        questionList.add("Explain the firstOrNull function for collections in Kotlin?")
        questionList.add("Explain the groupBy function for collections in Kotlin?")
        questionList.add("Explain the count function for collections in Kotlin?")
        questionList.add("Explain the filter function for collections in Kotlin?")
        questionList.add("Explain the map function for collections in Kotlin?")
        questionList.add("Explain the distinct  function for collections in Kotlin?")
        questionList.add("Explain the distinctBy function for collections in Kotlin?")
        questionList.add("Explain the flatMap function for collections in Kotlin?")
        questionList.add("Explain the reduce function for collections in Kotlin?")
        questionList.add("Explain the maxByOrNull / minByOrNull function for collections in Kotlin?")
        questionList.add("Explain the associateBy function for collections in Kotlin?")
        questionList.add("Explain the partition function for collections in Kotlin?")
        questionList.add("Explain the drop / take function for collections in Kotlin?")
        questionList.add("Explain the plus / minus operators for collections in Kotlin?")
...
//                .show()
    ...
    fun showQuestionsInAlertDialog() {
        val stringList = questionList// Replace this with your String ArrayList

        val recyclerView = RecyclerView(this)
        recyclerView.layoutManager = LinearLayoutManager(this)
        recyclerView.adapter = StringAdapter(stringList,position)
